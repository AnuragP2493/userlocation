...
module.exports = "<app-user *ngIf=\"user\" [user]=\"user\"></app-user>\n"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_service_users_service__WEBPACK_IMPORTED_MODULE_1__["UsersService"]])
    ], AppComponent);
    return AppComponent;
}());
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _user_user_component__WEBPACK_IMPORTED_MODULE_3__["UserComponent"]],
...
module.exports = "<div class=\"container\">\n  <div class=\"card\">\n    <div class=\"card-body\">\n      <p class=\"card-text bold\">\n        List of User within 100KM area from Dublin\n      </p>\n    </div>\n  </div>\n  <table class=\"table table-bordered\">\n    <thead>\n      <tr>\n        <th scope=\"col\">User ID</th>\n        <th scope=\"col\">User Name</th>\n        <th scope=\"col\">Distance</th>\n      </tr>\n    </thead>\n    <tbody>\n      <tr *ngFor=\"let user of nearByUser\">\n        <td>{{ user.user.user_id }}</td>\n        <td>{{ user.user.name }}</td>\n        <th scope=\"row\">{{ user.dis | number: \"1.2-2\" }} km</th>\n      </tr>\n    </tbody>\n  </table>\n</div>\n"
...
var UserComponent = /** @class */ (function () {
    function UserComponent() {
        this.lat1 = 53.339428; // Dublin lattitude
        this.lon1 = -6.257664; // Dublin longitude
        this.nearByUser = [];
    }
    UserComponent.prototype.ngOnChanges = function (changes) {
        var _this = this;
        this.user.filter(function (item) {
            (_this.lat2 = item.latitude), (_this.lon2 = item.longitude);
            _this.getDistanceFromLatLonInKm(_this.lat1, _this.lon1, _this.lat2, _this.lon2, item);
        });
    };
    UserComponent.prototype.ngOnInit = function () { };
    UserComponent.prototype.getDistanceFromLatLonInKm = function (lat1, lon1, lat2, lon2, user) {
        var obj = {
            dis: null,
            user: null
        };
        ...
        if (d < 100) {
            obj.dis = d;
            obj.user = __assign({}, user);
            this.nearByUser.push(obj);
            this.nearByUser.sort(this.sortById);
        }
    };
    UserComponent.prototype.sortById = function (a, b) {
        var comp = 0;
    ...
    UserComponent.prototype.deg2rad = function (deg) {
